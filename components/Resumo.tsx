...
<button
  ...
  onClick={async () => {
    ...
    if (comprovante) {
try {
  // 🔑 Obter token (opcional, se necessário para API interna)
  ...
  // 🔥 Preparar FormData para a rota API
  ...
  const updateData: any = {
    ...
    comprovante_pagamento: urlComprovante,
  };
  ...
  console.error("Erro ao enviar comprovante via API:", err);
